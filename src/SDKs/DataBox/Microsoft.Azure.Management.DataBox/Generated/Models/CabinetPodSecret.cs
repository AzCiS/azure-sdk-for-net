...
namespace Microsoft.Azure.Management.DataBox.Models
{
    ...
    /// </summary>
    public partial class CabinetPodSecret
    {
        /// <summary>
        /// Initializes a new instance of the CabinetPodSecret class.
        /// </summary>
        public CabinetPodSecret() { }
        ...
        /// credentials.</param>
        public CabinetPodSecret(string deviceSerialNumber = default(string), string devicePassword = default(string), IList<AccountCredentialDetails> accountCredentialDetails = default(IList<AccountCredentialDetails>))
        {
